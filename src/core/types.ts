...
export type TodoAppAction =
  | { type: 'CREATE_TASK'; payload: Omit<Task, 'id' | 'createdAt' | 'updatedAt' | 'engagementEvents'> }
  | { type: 'UPDATE_TASK'; payload: { id: string; updates: Partial<Task> } }
  | { type: 'DELETE_TASK'; payload: { id: string } }
  | { type: 'ASSIGN_TASK'; payload: { taskId: string; userId: string } }
  | { type: 'UNASSIGN_TASK'; payload: { taskId: string; userId: string } }
  | { type: 'COMPLETE_TASK'; payload: { id: string } }
  | { type: 'ADD_ENGAGEMENT_EVENT'; payload: { taskId: string; event: EngagementEvent } }
